...
public class ReadTxT {
	...
	public static void readTwoTxT(String file1, String file2) {
		...
		try {
			...
			System.out.println("文件A中的单词数为：");
			txTModule.printWords(words1);
			System.out.println("文件B中的单词数为：");
			txTModule.printWords(words2);

			System.out.println("wd∈A且wd ∉B的单词占A文件的百分比");
			...
			System.out.println("wd∈B且 wd∉A的单词占B文件的百分比");
